...
@section('content')
    ...
    <div class="search-form">
        <input style="width: 4000px" type="text" id="searchInput" placeholder="Search by title, governorate or address...">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function filterTable() {
                ...
                rows.forEach(row => {
                    const title =
                        row.querySelector("td:nth-child(1) strong")?.textContent.toLowerCase() || "";

                    const govCell = row.querySelector(".gov-cell");
                    const governorateName =
                        govCell?.textContent.toLowerCase().trim() || "";
                    const governorateId =
                        govCell?.dataset.govId?.trim() || "";
